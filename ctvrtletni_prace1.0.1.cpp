 ...
 */
 ...
 int main(){
     ...
     int vyberHlavni,podVyber, zboziLoop, slevaVyber, platbaVyber,/*urcuji akce ve ruznych menu*/ pocetVKosiku=0/*celkovy pocet veci v kosiku*/, random, platbaPotvrzeni;//urcuje ruzna random cisla
     ...
     while(reset1==1){
         bool reset2=1, resetSleva=1, resetCoupon=1, resetPlatba=1;/* opakovani ostatnich menu*/
         system("cls");
